...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f("ix_transfer_to_stop_pk"), table_name="transfer")
    op.drop_index(op.f("ix_transfer_source_pk"), table_name="transfer")
    op.drop_index(op.f("ix_transfer_from_stop_pk"), table_name="transfer")
